...
qualificationRunnerFolder = 'C:\CompletSetup_SBSuite\OSPSuite_Setups\OSP_Suite_8.0\QualificationRunner';
markdownJoinerFolder = 'C:\2del\MDJoinerTMP'; %'C:\CompletSetup_SBSuite\OSPSuite_Setups\OSP_Suite_8.0\MD';
...
basisDir = 'C:\000_QualiSebastian\00_Evaluation-plan-template\Evaluation';
...
REInput_path = fullfile('C:\SW-Dev\Reporting-Engine\branches\3.0\src\dist','re_input');
REOutput_path = fullfile('C:\SW-Dev\Reporting-Engine\branches\3.0\src\dist','re_output');
ReportOutput_path=fullfile('C:\SW-Dev\Reporting-Engine\branches\3.0\src\dist','report');
