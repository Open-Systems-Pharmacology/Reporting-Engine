...
for iSet = 1:length(MeanModelSet)
    ...
    save(fullfile(tmpDir,'sens_Mean.mat'),'sens');
    ...
    plotSensitivity(WSettings,MeanModelSet.name,sens,OutputList,sensParameterList,FP);
...
function plotSensitivity(WSettings,analysisName,sens,OutputList,sensParameterList,FP)
