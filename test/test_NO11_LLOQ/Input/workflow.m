...
% M&S activity:
% Validation level:
% Original author: ZTCOK 22-Aug-2017 09:28:16
% 
%  HOW TO USE
...
clear MeanModelSet
OutputList(1) = struct('pathID','Organism|PeripheralVenousBlood|Theophylline|Plasma (Peripheral Venous Blood)','reportName','Theophylline plasma concentration ','displayUnit','mg/l','dataTpFilter','CMT==1','residualScale','log','unitFactor',NaN,'pKParameterList',[]);
