...
xmlList = {'Children_OralSingle_IV_Multi_withTypo.xml'};
% list of all population csv, 
% first column name of csv file, second column description for reporting
popList = {'Children_OralSingle_IV_Multi_withTypo.csv','virtual population for test scripts'};

% list of all outputs 
outputcsv = {'Output_withTypo.csv'};
