...
% Purpose:: Test Case for missing files and typos
% M&S activity:: None
% Validation level:: No validation necessary
% Original author: ZTCOK 14-Nov-2017 12:41:30
% 
%  HOW TO USE
...
OutputList(4).pKParameterList = {'C_max','C_max_norm','C_max_t1_t2','C_max_t1_t2_norm','C_max_tLast_tEnd','C_max_tLast_tEnd_norm','t_max','t_max_t1_t2','t_max_tLast_tEnd','C_trough_t2','C_trough_tLast','AUC_t1_t2','AUC_t1_t2_norm','AUC_tLast_minus_1_tLast','AUC_tLast_minus_1_tLast_norm','AUC_inf_t1','AUC_inf_t1_norm','AUC_inf_tLast','AUC_inf_tLast_norm','MRT','Thalf','Thalf_tLast_tEnd','F_max';'','µmol/l','typo2','µmol/l','mg/l','µmol/l','mg/l','h','h','h','µmol/l','µmol/l','µmol*min/l','µg*min/l','µmol*min/l','µg*min/l','µmol*min/l','µg*min/l','µmol*min/l','µg*min/l','h','h','h'};
...
OutputList(5).pKParameterList = {'C_max','C_max_norm','C_max_t1_t2','C_max_t1_t2_norm','C_max_tLast_tEnd','C_max_tLast_tEnd_norm','t_max','t_max_t1_t2','t_max_tLast_tEnd','C_trough_t2','C_trough_tLast','AUC_t1_t2','AUC_t1_t2_norm','AUC_tLast_minus_1_tLast','AUC_tLast_minus_1_tLast_norm','AUC_inf_t1','AUC_inf_t1_norm','AUC_inf_tLast','AUC_inf_tLast_norm','MRT','Thalf','Thalf_tLast_tEnd','F_max';'','h','mg/l','µmol/l','mg/l','µmol/l','mg/l','h','h','h','µmol/l','µmol/l','µmol*min/l','µg*min/l','µmol*min/l','µg*min/l','µmol*min/l','µg*min/l','µmol*min/l','µg*min/l','h','h','h'};
PopRunSet(1) = struct('name','OralSingle_IV_Multi','reportName','Multi IV and PO application','boxwhiskerLabel','','xml','Children_OralSingle_IV_Multi_withTypo.xml','studyDesign','','isReference',0,'popcsv','Children_OralSingle_IV_Multi_withTypo.csv','popReportName','virtual test population','calculatePKParameterFh','','dataTpFilter','AMT==0 & STUD==11826','dataReportName','Study data 11826','OutputList',OutputList);
clear OutputList
...
dataFiles(1,:) = {'data.nmdat','tpDictionary.csv','timeprofile'};
