...
% old comparison file
dataComp  = readtab(fullfile('simulationExportPKSIm','SimplePop_Single_IVBolus-Results.csv'),';',0,0,1,0);
...
% New generated file
data = readtab(fullfile('simulations','SingleIvBolus-PK-Analyses.csv'),';',0,0,1,0);
% old comparison file
dataComp  = readtab(fullfile('simulationExportPKSIm','SimplePop_Single_IVBolus-PK-Analyses.csv'),';',0,0,1,0);
