...
xmlList = {'Europeans_IVSingle_BSA.xml'};

% list of all population csv, 
% first column name of csv file, second column description used in figures and tables
popList = {'Europeans_IVSingle_BSA.csv','virtual population for test scripts'}; % (source xxx.pksim5)
...
studyDesignList = {'StudyDesign.csv'};
...
% add dosing table
PopRunSet(1).studyDesign = studyDesignList{1};
