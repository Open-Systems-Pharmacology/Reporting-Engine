...
clear PopRunSet
OutputList(1) = struct('pathID','Organism|PeripheralVenousBlood|Hydroxy_Itraconazole|Plasma (Peripheral Venous Blood)','reportName','Hydroxy Itraconazole','displayUnit','µg/l','dataTpFilter','','residualScale','log','unitFactor',NaN,'pKParameterList',[]);
...
OutputList(2) = struct('pathID','Organism|PeripheralVenousBlood|Itraconazole|Plasma (Peripheral Venous Blood)','reportName','Itraconazole','displayUnit','µg/l','dataTpFilter','','residualScale','log','unitFactor',NaN,'pKParameterList',[]);
...
OutputList(3) = struct('pathID','Organism|PeripheralVenousBlood|Midazolam|Plasma (Peripheral Venous Blood)','reportName','Midazolam','displayUnit','µg/l','dataTpFilter','','residualScale','log','unitFactor',NaN,'pKParameterList',[]);
